...
#define TE_PROFILE_SCOPE(name) constexpr auto fixedName = ::TE::InstrumentorUtils::CleanupOutputString(name, "__cdecl ");\
									::TE::InstrumentationTimer timer##__LINE__(fixedName.Data)
